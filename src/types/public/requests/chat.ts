import { z } from 'zod';
import { MessageRoleValues, ResponseFormatValues } from '../../shared/enums.js';

export const messageSchema = z.object({
  role: z.enum(Object.values(MessageRoleValues) as [string, ...string[]]),
  content: z.string(),
});

export const responseFormatSchema = z.object({
  type: z.enum(Object.values(ResponseFormatValues) as [string, ...string[]]),
});
